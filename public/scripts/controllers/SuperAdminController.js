(function () {
  ...
  function SuperAdminController($scope, userService, repositoryService, examService, $state, $q, $http, $window) {
  ...
  SuperAdminController.$inject = ['$scope', 'userService', 'repositoryService', 'examService', '$state', '$q', '$http'];
