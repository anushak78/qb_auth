(function () {
  ...
  function QBAdminController($scope, userService, repositoryService, examService, $state, $q, $http, $window) {
  ...
  angular
    ...
    .controller('QBAdminController', QBAdminController);

  QBAdminController.$inject = ['$scope', 'userService', 'repositoryService', 'examService', '$state', '$q', '$http'];
